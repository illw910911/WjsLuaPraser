...
namespace Babe.Lua.Grammar
{
    ...
    public class LuaGrammar : Irony.Parsing.Grammar
    {
            ...
            base(true)
        {
            ...
            //var TypeSymbol = new LuaTypeSymbolTerminal(LuaTerminalNames.TypeSymbol);
            //  Regular Operators
            ...
            //NonGrammarTerminals.Add(TypeSymbol);
            ...
            //NonTerminal TypeSymbol = new NonTerminal(LuaTerminalNames.TypeSymbol);
            #endregion
