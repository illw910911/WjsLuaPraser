...
{
    public class LuaTypeSymbolTerminal :Terminal
    {
        public LuaTypeSymbolTerminal(string name)
            : base(name, TokenCategory.TYPE_SYMBOL)
        {
            //此处优先级高于普通的注释
            Priority = TerminalPriority.High + 50;
            this.SetFlag(TermFlags.None);
        }
